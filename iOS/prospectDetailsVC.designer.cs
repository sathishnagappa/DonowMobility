...
namespace donow.iOS
{
	[Register ("prospectDetailsVC")]
	partial class prospectDetailsVC
	{
		[Outlet]
		...
		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UILabel LabelProspectCompanyName { get; set; }
		...
		void ReleaseDesignerOutlets ()
		{
			...
			if (LabelProspectCompanyName != null) {
				LabelProspectCompanyName.Dispose ();
				LabelProspectCompanyName = null;
			}
